...
!macro wails.restoreInstallDir ROOT
    ReadRegStr $0 ${ROOT} "${UNINST_KEY}" "InstallLocation"
    ${If} $0 == ""
        # Older installers did not persist InstallLocation. Their quoted
        # uninstall command still provides a stable path for upgrades.
...
Function .onInit
   ...
   !ifdef WAILS_INSTALL_SCOPE
     ...
     !else
       !insertmacro wails.restoreInstallDir HKLM
     !endif
   !else
     !insertmacro wails.restoreInstallDir HKLM
   !endif
